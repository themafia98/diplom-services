...
const cachingThunk = (dependencies) => async (dispatch, getState, { schema }) => {
...
const putterCacheThunk = (dependencies) => async (dispatch, getState, { schema, Request }) => {
...
const getterCacheThunk = (dependencies) => async (dispatch, getState, { schema, Request }) => {
