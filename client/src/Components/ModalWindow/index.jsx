...
class ModalWindow extends React.Component {
    ...
    render(){
        ...
        return (
            <div>
                <Button type="primary" onClick={this.showModal}>Registration</Button>
                    <Modal  
                    ...
                    >
                        ...
                        <Select onChange = {this.onChangeSelect}   className = 'selectDepartament' placeholder="Select a departament" optionFilterProp="depart">
