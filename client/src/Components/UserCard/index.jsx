        ...
        return (
            <div className = 'userCard'>
                ...
                <div className = 'mainContentCard'>
                    ...
                    <div className = 'col-6'>
                        <p className = 'summary'>
                            My name Pavel Petrovich and I'm Frontend developer. I looking for job. I looking for job. I looking for job.
                             I looking for job. I looking for job. I looking for job. I looking for job.
                        </p>
                        <div className = 'contact'>
                            {data.mail ? <div className = 'email'><Icon type="mail" /> <span>{data.email}</span></div> : null}
                            {data.phone ? <div className = 'phone'><Icon type="phone" /> <span>{data.phone}</span></div> : null}
                        </div>
                    </div>
                </div>
            </div>
